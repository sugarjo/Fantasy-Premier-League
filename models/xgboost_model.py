...
def objective(space):
    ...
    cv_X, val_X, cv_y, val_y, cv_sample_weights, _, cv_stratify, _ = train_test_split(train_X, train_y, sample_weights, stratify, test_size=0.25, stratify=stratify)
    
    #get som data for evaluation       
    fit_X, eval_X, fit_y, eval_y, fit_sample_weights, _ =  train_test_split(cv_X, cv_y, cv_sample_weights, test_size=space['eval_fraction'], stratify=cv_stratify)    
