...
exclude_players = ['Lewis', 'Tosin', 'Wilson', 'Savinho', 'Amad', 'Chalobah', 'Solanke', 'Amadou Onana', 'Tsimikas', 'Fabianski', 'Trippier', 'Doku', 'Lamptey', 'Maddison', 'Quansah', 'Stones']
include_players = []
